...
class CTrackRtStartTimeCtrl : public ITcOCFCtrlImpl<CTrackRtStartTimeCtrl, CTrackRtStartTimeClassFactory>
{
public:
...
{
	HRESULT hr = E_FAIL;
	TRACE("TrackRtStartTime: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CTrackRtStartTimeCtrl>;
